...
// guessTypeNameFromImport attempts to guess the main type name from a proto import path.
...
func (o *Object) guessTypeNameFromImport(importPath string) string {
	...
	// Handle well-known google types with standard naming patterns
	...
	// For other imports, we can't reliably guess the type name
	return ""
}
